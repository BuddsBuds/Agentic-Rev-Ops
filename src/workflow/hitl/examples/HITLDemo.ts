// HITL Demo - Comprehensive demonstration of Human-in-the-Loop system
import { HITLSystem } from '../HITLSystem';
...
/**
 * Comprehensive demo showcasing all HITL system capabilities
 */
export class HITLDemo {
  ...
  private async setupDemo(): Promise<void> {
    ...
    this.swarmCoordinator = new SwarmCoordinator(this.swarmMemory);

    // Initialize HITL System with demo configuration
    this.hitlSystem = new HITLSystem(
      this.swarmMemory,
      this.swarmCoordinator,
      this.getDemoConfiguration()
    );
  ...
  private getDemoConfiguration() {
    return {
      ...
      tracking: {
        snapshotInterval: 2, // 2 minutes for demo
        alertThresholds: {
          timeOverrun: 20,
          qualityBelow: 3.5,
          riskAbove: 'medium',
  ...
  public async runDemo(): Promise<void> {
    try {
      ...
      for (const scenario of this.demoScenarios) {
        ...
        await this.sleep(3000); // Wait between scenarios
      }
   ...
   */
  public async runScenario(scenario: DemoScenario): Promise<void> {
   ...
   * Register demo operators
   */
  private async registerDemoOperators(): Promise<void> {
  ...
  private async runHighConfidenceScenario(): Promise<void> {
  ...
  private async runMediumConfidenceScenario(): Promise<void> {
  ...
  private async runLowConfidenceScenario(): Promise<void> {
    ...
    const swarmRequest = {
      ...
      context: {
        ...
        timeConstraints: {
          ...
          maxDelay: 720 // 12 hours max delay
        },
        dependencies: [
          'Legal review',
          'Financial modeling',
  ...
  private async runEmergencyScenario(): Promise<void> {
    ...
    const criticalRequest = {
      ...
      context: {
        ...
        timeConstraints: {
          ...
          maxDelay: 30 // 30 minutes max delay
        },
    ...
    // Now demonstrate emergency override
  ...
  private async runComplexWorkflowScenario(): Promise<void> {
    console.log('🔄 Simulating complex multi-stage workflow...');

    // Create a strategic decision that will trigger a complex workflow
  ...
  private async runTaskDelegationScenario(): Promise<void> {
    ...
    // Create several different types of tasks
    const tasks = [
      {
    ...
    for (const taskData of tasks) {
      ...
      // Wait a moment between task creations
  ...
  private async runLearningScenario(): Promise<void> {
    console.log('🧠 Simulating learning and adaptation scenario...');

    // Simulate a series of decisions to demonstrate learning
    ...
    for (const [index, decision] of learningDecisions.entries()) {
      ...
      // Simulate the learning data recording
      if (swarmIntegration) {
        const learningData = {
        ...
        // Simulate recording learning data
  ...
  private async runMonitoringScenario(): Promise<void> {
    ...
    // Simulate various monitoring conditions
    ...
    for (const [index, event] of monitoringEvents.entries()) {
      ...
      // Simulate creating alerts through the progress tracker
      const alert = {
